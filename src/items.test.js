...
describe('listItems should return a list of items sorted', () => {
  test('sortItemsByName ascending', () => {
    expect(sortItemsByName(items, true)).toEqual(itemsNameAsc);
  });

  test('sortItemsByName descending', () => {
    expect(sortItemsByName(items, false)).toEqual(itemsNameDesc);
  });

  test('sortItemsByWeight ascending', () => {
    expect(sortItemsByWeight(items, true)).toEqual(itemsWeightAsc);
  });

  test('sortItemsByWeight descending', () => {
    expect(sortItemsByWeight(items, false)).toEqual(itemsWeightDesc);
  });
});
